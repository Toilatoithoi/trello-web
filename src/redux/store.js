...
const rootPersistConfig = {
  ...
  whitelist: ['user'] // định nghĩa các slice dữ liệu ĐƯỢC PHÉP duy trì qua mỗi lần 15 trình duyệt
  // blacklist: ['user'] // đinh nghĩa các slice KHÔNG ĐƯỢC PHÉP duy trì qua mỗi lần 15 trình duyệt
}
