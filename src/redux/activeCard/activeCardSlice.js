...
export const activeCardSlice = createSlice({
  ...
  reducers: {
    ...
    updateCurrentActiveCard: (state, action) => {
      const fullCard = action.payload // action.payload là chuẩn đặt tên nhận dữ liệu vào reducer, ở đây chúng ta gán nó ra một biển có nghĩa hơn
...
export const selecIsShowModalActiveCard = (state) => {
