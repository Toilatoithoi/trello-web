...
export const notificationsSlice = createSlice({
  ...
  reducers: {
    ...
    addNotification: (state, action) => {
      ...
      // unshift là thêm phần từ vào đầu màng, ngược lại với push
      state.currentNotifications.unshift(incomingInvitation)
    }
  },
  // ExtraReducers: Xu lý dữ liệu bất đồng bộ
  extraReducers: (builder) => {
    builder.addCase(fetchInvitationsAPI.fulfilled, (state, action) => {
      let incomingInvitations = action.payload
      // Đoạn này đào ngược lại màng invitations nhận được, đơn giản là đề hiển thị cái mới nhất lên đầu
...
// Selectors: Là nơi dành cho các components bên dưới gọi bằng hook useSelector() đề lấy dữ liệu từ trong kho redux store ra sử dụng
