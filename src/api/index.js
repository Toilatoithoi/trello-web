...
/**
* Lưu ý: Đối với việc sử dụng axios ở khóa MERN Stack Pro trên kênh YouTube: Trung QuanDev - Một Lập Trình Viên
* Tất cả các function bên dưới các bạn sẽ thấy mình chỉ request và lấy data từ respone luôn, mà không có try catch hay then catch gì đề bắt lỗi.
...
* Hiều đơn giản Interceptors là cách mà chúng ta sẽ đánh chặn vào giữa request hoặc response đề xử lý logic mà chúng ta muốn.
