...
function Column({ column }) {
  ...
  const dndKitColumnStyles = {
    ...
    // Lưu ý lúc này phải kết hợp với {...listerners} nằm ở Box chứ không phải ở div ngoài cùng tránh trường hợp kéo vào vùng xanh
    height: '100%',
  ...
  // Cards đã được sắp xếp ở componet cha cao nhất (boards/ _id.jsx) (Video 71 đã giải thích lý do)
  ...
  const handleDeleteColumn = () => {
    confirmDeleteColumn({
      title: 'Delete Column?',
      description: 'This action will permanently delete your Column and ít Cards! Are you sure?',
