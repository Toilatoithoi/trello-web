...
import VisuallyHiddenput from '~/components/Form/VisuallyHiddenInput'
...
/**
  *Note: Modal là một low-component mà bọn MUI sử dụng bên trong những thứ như Dialog, Drawer, Menu, Popover. Ở đây dĩ nhiên chúng ta có thể sử dụng Dialog cũng không thành vẫn đề gì, nhưng sẽ sử dụng Modal đề dễ linh hoạt tùy biến giao diện từ con số ở cho phù hợp với mọi nhu cầu nhé.
*/
      ...
      <Box sx={{
        ...
        {activeCard?.cover &&
          <Box sx={{ mb: 4 }}>
            <img
              style={{
                width: '100%', height: '320px', borderRadius: '6px', objectFit: 'cover'
              }}
          ...
          <Grid xs={12} sm={3}>
            ...
            <Stack direction="column" spacing={1}>
              ...
              <SidebarItem className="active" component="label">
                ...
                Cover
                <VisuallyHiddenput type="file" onChange={onUploadCardCover} />
              </SidebarItem>
