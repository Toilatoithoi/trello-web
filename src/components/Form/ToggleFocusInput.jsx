// https://youtube.com/@trungquandev // TrungQuanDev:
import { useState } from 'react'
import TextField from '@mui/material/TextField'

// Một Trick xử lý css khá hay trong việc làm UI UX khi cần ần hiện một cái input: Hiều đơn giản là thay vì phải tạo biển State để chuyển đồi qua lại giữa thẻ Input và Text thông thường thì chúng ta sẽ CSS lại cho cái thẻ Input trông như text bình thường, chỉ khi click và focus vào nó thì style lại trở về như cái input ban đầu.
...
function ToggleFocusInput({ value, onChangedValue, inputFontSize = '16px', ...props }) {
  ...
  const triggerBlur = () => {
    // Support TRim cái dữ liệu State inputValue cho đẹp luôn sai khi blur ra ngoài
    setInputValue(inputValue.trim())

    // Nếu giá trị không có gì thay đổi hoặc nếu user xoá hết nội dụng thì set lại giá trị gốc từ props cà return luôn không làm gì the
    if (!inputValue) {
      setInputValue(value)
      return
    }

    // Nếu giá trị không còn thay đổi thì cũng return không làm gì
